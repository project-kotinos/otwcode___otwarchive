...
sh /usr/bin/redis-server  /etc/redis/redis2.conf
sh /usr/bin/redis-server  /etc/redis/redis3.conf
sh /usr/bin/redis-server  /etc/redis/redis4.conf
sh /usr/bin/redis-server  /etc/redis/redis5.conf
sh /usr/bin/redis-server  /etc/redis/redis6.conf
